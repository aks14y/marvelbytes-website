...
const liquidbuttonVariants = cva(
  "relative inline-flex items-center justify-center cursor-pointer gap-2 whitespace-nowrap rounded-full bg-transparent text-sm font-medium transition-[transform,color,box-shadow] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default:
          "hover:scale-105 duration-300 transition text-primary",
        destructive:
          "text-white hover:scale-105 duration-300 transition",
        outline:
          "hover:scale-105 duration-300 transition text-white/90 hover:text-white",
        secondary:
          "hover:scale-105 duration-300 transition text-secondary-foreground",
  ...
  return (
    ...
    >
      <div
        aria-hidden
        className={cn(
          "pointer-events-none absolute inset-0 z-0 rounded-full transition-all",
          rimShadow
        )}
      />
      <div
